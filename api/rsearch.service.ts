...
import { AlgorithmFailure } from '../model/algorithmFailure';
import { AlgorithmSimilarDocsQuery } from '../model/algorithmSimilarDocsQuery';
import { AlgorithmSuccess } from '../model/algorithmSuccess';
...
import { IndexesSearchQuery } from '../model/indexesSearchQuery';
import { IndexesSuggestQuery } from '../model/indexesSuggestQuery';
...
export class RsearchService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getAdvancedMultiIndexSearchResults(search: IndexesSearchQuery, observe?: 'body', reportProgress?: boolean): Observable<SearchSuccess>;
    public getAdvancedMultiIndexSearchResults(search: IndexesSearchQuery, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<SearchSuccess>>;
    public getAdvancedMultiIndexSearchResults(search: IndexesSearchQuery, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<SearchSuccess>>;
    public getAdvancedMultiIndexSearchResults(search: IndexesSearchQuery, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (search === null || search === undefined) {
            throw new Error('Required parameter search was null or undefined when calling getAdvancedMultiIndexSearchResults.');
        }
        ...
        return this.httpClient.post<SearchSuccess>(`${this.basePath}/indexes/search`,
            search,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getAdvancedMultiIndexSuggestResults(suggest: IndexesSuggestQuery, observe?: 'body', reportProgress?: boolean): Observable<SuggestSuccess>;
    public getAdvancedMultiIndexSuggestResults(suggest: IndexesSuggestQuery, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<SuggestSuccess>>;
    public getAdvancedMultiIndexSuggestResults(suggest: IndexesSuggestQuery, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<SuggestSuccess>>;
    public getAdvancedMultiIndexSuggestResults(suggest: IndexesSuggestQuery, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (suggest === null || suggest === undefined) {
            throw new Error('Required parameter suggest was null or undefined when calling getAdvancedMultiIndexSuggestResults.');
        }
        ...
        return this.httpClient.post<SuggestSuccess>(`${this.basePath}/indexes/suggest`,
            suggest,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getSimilarDocsResults(algorithm: AlgorithmSimilarDocsQuery, observe?: 'body', reportProgress?: boolean): Observable<AlgorithmSuccess>;
    public getSimilarDocsResults(algorithm: AlgorithmSimilarDocsQuery, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<AlgorithmSuccess>>;
    public getSimilarDocsResults(algorithm: AlgorithmSimilarDocsQuery, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<AlgorithmSuccess>>;
    public getSimilarDocsResults(algorithm: AlgorithmSimilarDocsQuery, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (algorithm === null || algorithm === undefined) {
            throw new Error('Required parameter algorithm was null or undefined when calling getSimilarDocsResults.');
        }
        ...
        return this.httpClient.post<AlgorithmSuccess>(`${this.basePath}/indexes/algorithms/similardocs`,
            algorithm,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
